  ...
  const experiences = [
    {
      ...
      description:
        "Leading frontend development for a Web3 platform with 50K+ active users",
      link: "https://linktr.ee/spheronfdn",
      achievements: [
        "Architected and scaled Spheron's core frontend platform, supporting 50K+ active users with high performance and modularity",
    ...
    },
    {
      ...
      description:
        "Provided technical support and enhancements for enterprise platforms",
      link: "",
      achievements: [
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-dark-600 dark:text-dark-300 max-w-3xl mx-auto">
            My professional journey spanning 5+ years in software development,
            from freelance work to leading Web3 platform development.
          </p>
        </motion.div>
        ...
        <div className="space-y-12">
          {experiences.map((experience, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden"
            >
                ...
                <div className="flex-1">
                  {experience.link.length > 0 && (
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      >
                        <h3 className="text-2xl font-bold text-dark-800 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200">
                          {experience.title}
                        </h3>
